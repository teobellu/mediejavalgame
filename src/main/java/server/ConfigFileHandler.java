...
import model.effects.EffectConvertResource;
...
import model.effects.EffectDontGetVictoryFor;
import model.effects.EffectGetACard;
import model.effects.EffectGetResource;
import model.effects.EffectIncreaseActionPower;
import model.effects.EffectIncreaseFamiliarStartPower;
import model.effects.EffectLostVictoryDepicted;
import model.effects.EffectLostVictoryForEach;
import model.effects.EffectOverruleObject;
import model.effects.EffectPayMoreForIncreaseWorker;
import model.effects.EffectRecieveRewardForEach;
