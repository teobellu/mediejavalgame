...
import server.game.effectControllers.EffectConvertResource;
...
import server.game.effectControllers.EffectDontGetVictoryFor;
import server.game.effectControllers.EffectGetACard;
import server.game.effectControllers.EffectGetResource;
import server.game.effectControllers.EffectIncreaseActionPower;
import server.game.effectControllers.EffectIncreaseFamiliarStartPower;
import server.game.effectControllers.EffectLostVictoryDepicted;
import server.game.effectControllers.EffectLostVictoryForEach;
import server.game.effectControllers.EffectOverruleObject;
import server.game.effectControllers.EffectPayMoreForIncreaseWorker;
import server.game.effectControllers.EffectRecieveRewardForEach;
